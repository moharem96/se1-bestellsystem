...
/**
 * Non-public singleton {@link system} component that implements the
 * {@link DataStore}
 * interface.
 * <p>
...
class DataStoreImpl implements DataStore, DataBuilder {
    ...
    /**
     * injected reference to repositories holding Customer-, Article- and Order
     * objects
     */
    ...
    /**
     * Constructor that creates internal {link DataFactory<T, ID>} and {link
     * Repository<T, ID>}
     * objects of respective types {@code T} for {link Customer}, {link Article} and
     * {link Order}.
     * 
    ...
    /**
     * Return Builder methods for {@link Customer}, {@link Article} and
     * {@link Order} objects.
     * 
     ...
     * 
     * @param factory access to factory to create {@code Customer} objects in the
     *                {@code DataStore}
     * @return chainable self-reference
     */
    @Override
     ...
     * 
     * @param factory access to factory to create {@code Article} objects in the
     *                {@code DataStore}
     * @return chainable self-reference
     */
    @Override
     ...
     * 
     * @param factory access to factory to create {@code Orders} objects in the
     *                {@code DataStore}
     * @return chainable self-reference
     */
    @Override
    ...
    /**
     * Return access to {@link Customer} objects through the
     * {@code Repository<Customer, Long>} interface.
     * 
    ...
    /**
     * Return access to {@link Article} objects through the
     * {@code Repository<Article, String>} interface.
     * 
    ...
    /**
     * Return access to {@link Order} objects through the
     * {@code Repository<Order, String>} interface.
     * 
